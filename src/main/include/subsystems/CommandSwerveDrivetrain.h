...
public:
    ...
    /**
     * \brief Returns a command that applies the specified control request to this swerve m_drivetrain.
     *
     * This captures the returned swerve request by reference, so it must live
     * for at least as long as the m_drivetrain. This can be done by storing the
     * request as a member variable of your m_drivetrain subsystem or robot.
     *
